export default function Input(props) {
    return (
        <label className="block mb-4">
            <span className="block mb-1 text-slate-600">{props.label}</span>
            {props.required ?
                <input className="block p-2 w-full max-w-md text-lg border rounded-md border-slate-300 text-slate-800
